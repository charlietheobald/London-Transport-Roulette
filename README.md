# London-Transport-Roulette

Hi everyone, welcome to the official download page for the Python program featured in Transport Roulette videos on the It's All About The Journey YouTube channel!




* How can I download the code, and how can I run it on my phone?
...
* Can I modify this code?
  * Yes, of course! Feel free to modify this code how you'd like to use it, or maybe even modify it for your city! With a few adjustments, this program will work in any city around the world! If you're familiar with using Github then feel free to fork this repo.



* Why did I create this program?

  * Transport Roulette has historically been played with three or more dice to determine the next transport mode, direction and number of stops. There is an issue with this though, and to see this we'll need to talk a little bit about maths.

  * When you add or multiply the results on two or more dice together, the result is NOT in fact random. This means that when you roll two dice to determine a number of stops to travel, or the next bus to catch, there are certain numbers that are more likely to come up than others (massive simplification - this is a transport channel, not a maths forum). Ideally, for example, we want every bus route to have an equal chance of coming up, and simulating this using a computer program makes this much more likely to be random than using dice. Python also allows more complicated things to run in the background too that would be much more difficult if you were to use dice (see below!)
